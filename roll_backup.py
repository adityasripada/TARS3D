...
GAIT_POSITIONS = {
    # "step0": {6: 2975, 7: 3072, 8: 2975, 9: 1536, 10: 2975, 11: 3072, 12: 2975},
    ...
    "step4": {6: 3750, 7: 3072, 8: 2975, 9: 1536, 10: 2975, 11: 3072, 12: 2200},
    "step5": {6: 3750, 7: 3072, 8: 2975, 9: 1536, 10: 2975, 11: 3072, 12: 2975},
    "step6": {6: 3750, 7: 3072, 8: 2975, 9: 1536, 10: 2975, 11: 3072, 12: 2200},
    "step7": {6: 3750, 7: 3072, 8: 2975, 9: 1536, 10: 3750, 11: 3072, 12: 2200},
...
def move_motors_interpolated(
    ...
    for step_i in range(1, steps + 1):
        ...
        for _ in range(sim_steps_per_step):
            ...
            viewer.sync()
            time.sleep(0.0007)  # Sleep a tiny bit to avoid 100% CPU (optional)
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    for gait_key in GAIT_POSITIONS:
        ...
        move_motors_interpolated(
            current_positions, gait_positions, steps=2, sim_steps_per_step=95
        )
    # time.sleep(2)
    input("Press Enter to continue...")
    # move_motors_interpolated(gait_positions, HOME_POSITIONS)
    # time.sleep(1)
