...
GAIT_POSITIONS = {
    ...
    "step2_rot": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 2200, 11: 3072, 12: 3750}, # 9 rotates backward
    "step2_move": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 2200, 11: 3072, 12: 2200}, # 12 contracts
    "step4": {6: 3750, 7: 3072, 8: 2200, 9: 2048, 10: 2975, 11: 3072, 12: 2975}, # 6 extends and 8 contracts, shifting weight to other side
    "step5_rot": {6: 3750, 7: 3072, 8: 2200, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 9 rotates forward
    "step5_move": {6: 2200, 7: 3072, 8: 2200, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 6 contracts

    # Starts with 10, 12 in contact with the ground
    "step7": {6: 2975, 7: 3072, 8: 2975, 9: 3072, 10: 2200, 11: 3072, 12: 2200}, # 10 contracts and 12 extends, shifting weight to one side
    "step8_rot": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 2200, 11: 3072, 12: 2200}, # 9 rotates backward
    "step8_move": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 3750, 11: 3072, 12: 3750}, # 10 and 12 extend
    "step10": {6: 3750, 7: 3072, 8: 3750, 9: 2048, 10: 2975, 11: 3072, 12: 2975}, # 6 extends and 8 contracts, shifting weight to other side
    "step11_rot": {6: 3750, 7: 3072, 8: 3750, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 9 rotates forward
    "step11_move": {6: 2200, 7: 3072, 8: 3750, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 6 contracts

    # Starts with 10, 12 in contact with the ground
    "step13": {6: 2975, 7: 3072, 8: 2975, 9: 3072, 10: 3750, 11: 3072, 12: 2200}, # 10 extends and 12 contracts
    "step14_rot": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 3750, 11: 3072, 12: 2200}, # 9 rotates backward
    "step14_move": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 3750, 11: 3072, 12: 3750}, # 12 extends
    "step16": {6: 2200, 7: 3072, 8: 3750, 9: 2048, 10: 2975, 11: 3072, 12: 2975}, # 6 contracts and 8 extends
    "step17_rot": {6: 2200, 7: 3072, 8: 3750, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 9 rotates forward
    "step17_move": {6: 3750, 7: 3072, 8: 3750, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 6 extends

    # Starts with 10, 12 in contact with the ground
    "step19": {6: 2975, 7: 3072, 8: 2975, 9: 3072, 10: 3750, 11: 3072, 12: 3750}, # 10 and 12 extend
    "step20_rot": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 3750, 11: 3072, 12: 3750}, # 9 rotates backward
    "step20_move": {6: 2975, 7: 3072, 8: 2975, 9: 2048, 10: 2200, 11: 3072, 12: 2200}, # 10 and 12 contract
    "step22": {6: 2200, 7: 3072, 8: 2200, 9: 2048, 10: 2975, 11: 3072, 12: 2975}, # 6 and 8 contract
    "step23_rot": {6: 2200, 7: 3072, 8: 2200, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 9 rotates forward
    "step23_move": {6: 3750, 7: 3072, 8: 2200, 9: 3072, 10: 2975, 11: 3072, 12: 2975}, # 6 extends
}
...
def move_motors_interpolated(
    ...
    for step_i in range(1, steps + 1):
        ...
        for _ in range(sim_steps_per_step):
            ...
            viewer.sync()
            time.sleep(0.0001)  # Sleep a tiny bit to avoid 100% CPU (optional)
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    for gait_key in GAIT_POSITIONS:
        ...
        # Use different parameters based on whether it's a rotation step
        if "_rot" in gait_key:
            move_motors_interpolated(
                current_positions, gait_positions, steps=20, sim_steps_per_step=20
            )
        else:
            move_motors_interpolated(
                current_positions, gait_positions, steps=10, sim_steps_per_step=20
            )
